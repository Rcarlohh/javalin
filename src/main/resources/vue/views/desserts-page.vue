...
app.component("dessert-page", {
  ...
  setup() {
    const desserts = [
      { name: 'Frozen Yogurt', description: 'A tangy and creamy dessert...', icon: 'mdi-ice-cream', color: '#6EC1E4', calories: 159, fat: 6, carbs: 24, protein: 4, sodium: 87, calcium: '14%', iron: '1%' },
      { name: 'Ice cream sandwich', description: 'A classic treat...', icon: 'mdi-cookie', color: '#F4A261', calories: 237, fat: 9, carbs: 37, protein: 4.3, sodium: 129, calcium: '8%', iron: '1%' },
      { name: 'Eclair', description: 'A small, individual cake...', icon: 'mdi-cake-variant', color: '#6D4C41', calories: 262, fat: 16, carbs: 23, protein: 6, sodium: 337, calcium: '6%', iron: '7%' },
      { name: 'Cupcake', description: 'A small, individual cake...', icon: 'mdi-cupcake', color: '#FFADAD', calories: 305, fat: 3.7, carbs: 67, protein: 4.3, sodium: 413, calcium: '3%', iron: '8%' },
    ];
    return { desserts };
  }
});
...
<script>
    app.component("desserts-page", {
  template: "#desserts-page",
  setup() {
    const desserts = [
      {
        name: 'Frozen Yogurt',
        description: 'A tangy and creamy dessert made from yogurt...',
        icon: 'mdi-ice-cream',
        color: '#6EC1E4',
        calories: 159,
        fat: 6,
      ...
      {
        name: 'Ice cream sandwich',
        description: 'A classic treat featuring a layer of creamy ice cream...',
        icon: 'mdi-cookie',
        color: '#F4A261',
        calories: 237,
        fat: 9,
      ...
      {
        name: 'Eclair',
        description: 'A small, individual cake topped with frosting...',
        icon: 'mdi-cake-variant',
        color: '#6D4C41',
        calories: 262,
        fat: 16,
